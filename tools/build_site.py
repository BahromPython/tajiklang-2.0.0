...
<header>
  ...
  <p class="note">Дар браузер ҳеҷ насб лозим нест. Барои Windows, macOS ва
     Linux нусхаи мустақил ҳаст — ҳеҷ чизи дигар лозим нест.</p>
...
<section>
  <h2>TajikLang 3 · аз идея то лоиҳа</h2>
  <p class="sub">Версияи 3 як муҳити воҳид барои барнома, сомона, бозӣ,
     маълумот ва TajikBlocks меорад.</p>
  <div class="cards">
    <div class="card"><h3>Studio 3</h3><p>Папкаи лоиҳа, ҷустуҷӯ, санҷиш пеш аз иҷро, нигоҳдории худкор ва бастаҳоро дар як барнома мекушояд.</p></div>
    <div class="card"><h3>Лоиҳа дар як фармон</h3><p><code>tajik init web сомонаи_ман</code> ё қолаби console, game, blocks ва data — ҳар кадом бо муҳити худ.</p></div>
    <div class="card"><h3>Веб ва Blocks</h3><p>TajikWeb саҳифаҳои интерактивӣ месозад; TajikBlocks роҳро аз блокҳо ба рамзи воқеӣ мекушояд.</p></div>
    <div class="card"><h3>Муҳаррики мустақил</h3><p>Муҳоҷирати Rust оғоз шудааст. То баробар шудани санҷишҳо, муҳаррики санҷидашуда тамоми барномаҳои пешинаро нигоҳ медорад.</p></div>
  </div>
</section>
