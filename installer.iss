...
WizardStyle=modern
UninstallDisplayIcon={app}\tajik.exe
...
[Icons]
Name: "{autoprograms}\TajikLang"; Filename: "{app}\tajik.exe"; Parameters: "муҳаррир"; WorkingDir: "{app}"; Comment: "Муҳаррири TajikLang"
Name: "{autodesktop}\TajikLang"; Filename: "{app}\tajik.exe"; Parameters: "муҳаррир"; WorkingDir: "{app}"; Comment: "Муҳаррири TajikLang"
...
[Run]
Filename: "{app}\tajik.exe"; Parameters: "муҳаррир"; Description: "Муҳаррири TajikLang-ро кушоед"; Flags: nowait postinstall skipifsilent
